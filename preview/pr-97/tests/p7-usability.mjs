...
const backpack = readFileSync(join(root, 'backpack-system.js'), 'utf8');
...
if (!backpack.includes("window.GreywakeBackpack")) failures.push('Backpack system does not expose its current public API.');
