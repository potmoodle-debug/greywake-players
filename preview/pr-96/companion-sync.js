(() => {
  ...
  function same(a,b){return sameResources(a,b)&&JSON.stringify(a?.damage||null)===JSON.stringify(b?.damage||null)&&JSON.stringify(a?.rest||null)===JSON.stringify(b?.rest||null)&&JSON.stringify(a?.equipment||null)===JSON.stringify(b?.equipment||null);}
