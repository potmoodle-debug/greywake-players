(() => {
  const POSSIBILITIES = [
    ...
    },
    {
      ...
      known: 'The Groundfall lies east of Greywake along the known Kestrel Return route. The freight may still be recoverable, but time, scavengers, weather or other travellers may have changed what remains there.',
      relevance: {
