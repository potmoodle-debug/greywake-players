...
addReference("Travel & Distance","Player Reference",`<p>Greywake uses a simple local travel scale.</p><ul><li><strong>1 hex = 6 miles.</strong></li><li><strong>1 hex = about half a day of travel.</strong></li></ul><p>The map is a guide to distance and pressure rather than a promise that every route takes exactly the same effort. Terrain, injury, beasts, weather and what the party chooses to carry can all matter in the fiction.</p>`);

addReference("Water & Rest","Player Reference",`<p>Water is tracked because rest outside Greywake depends on having enough to recover.</p><ul><li>A <strong>Short Rest</strong> costs 1 Water per character.</li><li>A <strong>Long Rest</strong> costs 1 Water per character.</li><li>Water is spent when resting, not simply for travelling a hex.</li></ul><p><strong>Without Water:</strong> a Short Rest provides no benefit. A Long Rest provides only the benefits of a Short Rest.</p><p>Inside Greywake, ordinary water is rationed through Valve Court under the Cistern Keepers.</p>`);
...
[
 ...
 ["The Wastes","Greywake"],["The Wastes","Travel & Distance"],["The Wastes","Caravan Work"],["The Wastes","Clay"],
 ["Travel & Distance","Water & Rest"],["Travel & Distance","Caravan Gate"],["Travel & Distance","Split Rock Shade"],["Travel & Distance","Old Marker Wash"],
