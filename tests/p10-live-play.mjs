...
for(const marker of ['ARMOR SLOTS','DAMAGE THRESHOLDS','WATER','p10-sticky','What can I do?','p10-action-chip','p10-traits-collapsed','GreywakeLivePlayUsability']){
...
console.log('P10 live-play usability smoke test passed');
