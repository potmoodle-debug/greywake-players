...
const backpack = read('backpack-system.js');
...
if (/MutationObserver/.test(mechanics+equipment+nomadic+backpack)) throw new Error('P9 mechanics must remain event-driven; no broad mutation observer.');
