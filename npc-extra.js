...
if(!window.GREYWAKE_CATEGORIES["People"].includes("Mara Vell"))window.GREYWAKE_CATEGORIES["People"].push("Mara Vell");
[["Mara Vell","Greywake"],["Mara Vell","Valve Court"],["Mara Vell","Known People"]].forEach(([a,b])=>{
