(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .gm-home-status-cell{padding:14px 16px;border-right:1px solid #343329;min-width:0}.gm-home-status-cell small{display:block;margin-bottom:5px;color:#8c8161;font-size:8px;font-weight:800;letter-spacing:.13em;text-transform:uppercase}.gm-home-status-cell strong{display:block;color:#e5dcc3;font-size:12px;line-height:1.35}.gm-home-status-priority strong{font:19px/1.15 Georgia,serif;color:#f0dda2}
      .gm-home-status-action{display:flex;align-items:center;padding:10px}.gm-home-status-action button{height:100%;min-height:48px;border:1px solid #8a7440;background:#2c2515;color:#efd993;padding:10px 16px;font-size:9px;font-weight:900;letter-spacing:.1em;text-transform:uppercase;cursor:pointer}.gm-home-status-pressure{padding:9px 14px;border-top:1px solid #343329;color:#958d78;font-size:10px;line-height:1.45}.gm-home-status-pressure b{color:#bea96b;font-size:8px;letter-spacing:.1em;text-transform:uppercase;margin-right:8px}
      ...
      @media(max-width:1120px){.gm-home-status-main{grid-template-columns:1fr 1fr}.gm-home-status-action{grid-column:span 2}.gm-home-status-cell:nth-child(even){border-right:0}}@media(max-width:760px){.gm-home-status-main{display:block}.gm-home-status-cell{border-right:0;border-bottom:1px solid #343329}.gm-home-status-action{display:block}.gm-home-status-action button{width:100%}}
    `;
  ...
  function ensureHomeStatus() {
    ...
    status.innerHTML = `
      <div class="gm-home-status-main">
        ...
        <div class="gm-home-status-action"><button type="button" data-open-gm-cockpit>Open GM Cockpit →</button></div>
      </div>
  ...
  function targetRoute(target) {
    if (target.closest('#gmCockpitShortcut,[data-open-gm-cockpit]')) return '#/gm-cockpit';
